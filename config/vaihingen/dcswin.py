...
train_dataset = VaihingenDataset(data_root='/media/ubuntu/762cdba6-78ae-4daa-9dfc-d3db8b704a24/fffsbx_projects/RFM-Seg/data/vaihingen/train', mode='train_images',
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(transform=val_aug)
test_dataset = VaihingenDataset(data_root='/media/ubuntu/762cdba6-78ae-4daa-9dfc-d3db8b704a24/fffsbx_projects/RFM-Seg/data/vaihingen/test',
                                transform=val_aug)
