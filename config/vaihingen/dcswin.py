...
weights_name = "dcswin-small-1024-ms-512crop-e30_freeze"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "dcswin-small-1024-ms-512crop-e30_freeze"
...
train_dataset = VaihingenDataset(data_root='/home/ligong1/zqy_project/GeoSeg_clip/data/vaihingen/train', mode='train_images',
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(transform=val_aug)
test_dataset = VaihingenDataset(data_root='/home/ligong1/zqy_project/GeoSeg_clip/data/vaihingen/test',
                                transform=val_aug)
