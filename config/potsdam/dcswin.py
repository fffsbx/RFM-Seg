...
weights_name = "dcswin-small-1024-ms-512crop-e30_V_fusetwo_L_fusethree"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "dcswin-small-1024-ms-512crop-e30_V_fusetwo_L_fusethree"
...
train_dataset = PotsdamDataset(data_root='data/potsdam_2.4/train', mode='train_images',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(transform=val_aug)
test_dataset = PotsdamDataset(data_root='data/potsdam_2.4/test',
                              transform=val_aug)
